            ...
            <div className="col align-items-center">
              ...
              <div className="col-md-12">
                <div className="row align-items-center">
                  <div className="row col-md-5">HP</div>
                ...
                <hr />
                <div className="row align-items-center">
                  <div className="row col-md-5">Attack</div>
                  <div className="col-12 col-md-7">
                    <div className="progress">
                      <div
                        className="progress-bar"
                ...
                <hr />
                <div className="row align-items-center">
                  <div className="row col-md-5">Defense</div>
                  <div className="col-12 col-md-7">
                    <div className="progress">
                      <div
                        className="progress-bar"
                ...
                <hr />
                <div className="row align-items-center">
                  <div className="row col-md-5">Speed</div>
                  <div className="col-12 col-md-7">
                    <div className="progress">
                      <div
                        className="progress-bar"
                ...
                <hr />
                <div className="row align-items-center">
                  <div className="row col-md-5">Special Attack</div>
                  <div className="col-12 col-md-7">
                    <div className="progress">
                      <div
                        className="progress-bar"
                ...
                <hr />
                <div className="row align-items-center">
                  <div className="row col-md-5">Special Defense</div>
                  <div className="col-12 col-md-7">
                    <div className="progress">
                      <div
                        className="progress-bar"
          ...
          <div className="card-body">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <h6 className="float-right">HatchSteps:</h6>
                  </div>
                  <div className="col-md-6">
